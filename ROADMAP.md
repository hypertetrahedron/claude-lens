...
|---|---|---|
| Additional local `.claude*` directories | Complete | Siblings of the primary dir are discovered and ingested; projects prefixed with the folder name. Covered by `test_sources.py`. |
